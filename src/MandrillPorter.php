<?php
    ...
    */
   class MandrillPorter extends GatewayPorterAbstract
   {
       ...
       * @throws \Exception
       */
      public function newMandrillSendTemplateRequestController ( string $slug,
                                                                 ...
                                                                 array $tags,
                                                                 array $contents,
                                                                 array $merge_tags ): MandrillSendTemplateRequestController
      {

         // Create the MandrillSendTemplateRequestData entity
         $request_data = new MandrillSendTemplateRequestData( 'sendTemplate',
                                                              $slug,
                                                              $merge_language,
                                                              $subject,
                                                              $sender,
         ...
         return new MandrillSendTemplateRequestController( $this->getSavedGatewayDataEntity( 'default' ),
                                                           $request_data,
       ...
       */
      public function newMandrillEmailAddress ( string $email_address,
                                                ?string $display_name,
                                                array $merge_tags ): MandrillEmailAddress
      {

         // Return a new entity
         return new MandrillEmailAddress( $email_address,
                                          $display_name,
                                          $merge_tags );
      }
